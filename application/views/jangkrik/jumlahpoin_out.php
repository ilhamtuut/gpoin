        ...
        <div class="panel-body">
        	...
        	<div class="col-md-1"></div>
        		...
        		<table border="0" cellspacing="5" cellpadding="5">
			        <tbody>
			        <tr>
			        	<form action="<?php echo base_url();?>jangkrik/hasil/poin_out" method="post" >
			            ...
			            <td>
			            	<select class="form-control" type="text" name="ket">
			            		<option value="">Pilih</option>
			            		<option value="BUY G POIN">Pembelian</option>
			            		<option value="TRANSFER G POIN">Transfer</option>
			            	</select>
			            </td>
			            <td width="2%"></td>
