            ...
            <div class="table-responsive"> 
				...
				<table id="data" class="table table-bordered table-hover table-striped">
					...
					<tr>
						...
						<a href="<?php echo base_url(); ?>jangkrik/customer/update_deactive/<?php echo $data->id; ?>" class="btn btn-danger" onclick="return confirm('Anda Yakin Ingin Menonaktifkan???')">
							Deactivated
						</a>
						</td>
