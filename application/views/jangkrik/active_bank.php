				...
				<table id="data" class="table table-bordered table-hover table-striped">
					...
					<tr>
						...
						<td style="text-align: center;"> 
							<a href="<?php echo base_url(); ?>jangkrik/bank/update_deactive_bank/<?php echo $data->id; ?>" class="btn btn-danger" onclick="return confirm('Anda Yakin Ingin Menonaktifkan???')">
							Deactivated
						</a>
						</td>
						</td>
